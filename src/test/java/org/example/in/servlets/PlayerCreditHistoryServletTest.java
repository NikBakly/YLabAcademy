...
class PlayerCreditHistoryServletTest {
    @Mock
    TransactionService transactionService;

    private PlayerCreditHistoryServlet servlet;
    ...
    void setUp() throws ServletException {
        ...
        servlet = new PlayerCreditHistoryServlet();
    ...
    @Test
    @DisplayName("Успешно нахождения всех историй типа кредит")
    void testCreditHistoryTransactions() throws IOException {
        ...
        verify(transactionService).findHistoryTransactions(playerId, TransactionType.CREDIT);
